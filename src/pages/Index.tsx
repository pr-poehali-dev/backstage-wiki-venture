...
const ARTICLES = [
  { title: 'Level 0 — «Жёлтые комнаты»', cat: 'Уровни', danger: 'Опасно', tag: 'class-1', link: '/level-0', excerpt: 'Бесконечный лабиринт случайно сгенерированных офисных помещений с жёлтыми обоями и гудящими лампами.' },
